#!/usr/bin/env bash
set -e
PCRE_SRC_URI="https://webwerks.dl.sourceforge.net/project/pcre/pcre/${PCRE_VERSION}/pcre-${PCRE_VERSION}.tar.bz2"
...
NGINX_MORE_HEADER_SRC_URI="https://github.com/openresty/headers-more-nginx-module/archive/v$NGINX_MORE_HEADERS.tar.gz"
...
download_and_extract(){
  ...
  tar -xf $SOURCE_DIR/$SOURCE_BINARY -C $NGINX_SETUP_DIR
}
...
download_and_extract $NGINX_MORE_HEADER_SRC_URI
...
./configure \
  ...
  --add-module=$NGINX_SETUP_DIR/headers-more-nginx-module-$NGINX_MORE_HEADERS \
